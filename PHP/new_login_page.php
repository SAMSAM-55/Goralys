...
<main class="main">
    <div class="connection-container">
        ...
        <form action="../backend/API/User/Auth/Login/" class="connection-form" method="post">
            ...
            <div class="input" id="password-container">
                ...
                <input type="password" name="password-login" id="password-login" autocomplete="current-password" required>
